...
Future<Either<statusReq, Map>> deleteData(String url, Map? data,{Map<String, dynamic>? queryParams, String? pathParam}) async {
  try {
    if (await checkInterne() == true) {
      print("Post");
      print("check  ${url}");
      ...
      print("check $url");
      var res = await http.delete(Uri.parse(url), body: data);
      print("check11");
      print("data is  ${data}");
      print(res.statusCode);
      if (res.statusCode == 200 || res.statusCode == 201) {
